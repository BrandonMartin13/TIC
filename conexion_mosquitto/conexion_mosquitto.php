...
function conectar()
{
  ...
  $mqttServer = "192.168.1.60"; // Dirección IP o nombre de dominio de tu servidor Mosquitto
  $mqttPort = 8883; // Puerto del complemento WebSocket de Mosquitto
  $mqttUsername = "brandon"; // Nombre de usuario MQTT (si es necesario)
...
{
//{ "device_id": "4e-4f-4d-42-52-45-31-32", "sensor": "Temperatura=26.70°C Humedad=34.00%", "tiempo": "2023-06-23T19:29:42.152605Z" }
